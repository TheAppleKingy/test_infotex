...
// QuerySentTransactions queries the sent_transactions edge of a Wallet.
func (c *WalletClient) QuerySentTransactions(w *Wallet) *TransactionQuery {
...
// QueryRecievedTransactions queries the recieved_transactions edge of a Wallet.
func (c *WalletClient) QueryRecievedTransactions(w *Wallet) *TransactionQuery {
	query := (&TransactionClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := w.ID
		step := sqlgraph.NewStep(
